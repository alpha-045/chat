import { Link, LogOut, MessageCircle, Settings, Settings2, UserPen } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <div className="bg-white px-4 py-5 shadow-md shadow-purple-200/50 rounded-md flex items-center justify-between flex-wrap gap-3">
